...
public class JdbcProjectDao implements ProjectDao {
	...
	public Project createProject(Project newProject) {
		...
		Integer projectId1 = jdbcTemplate.queryForObject(sql, Integer.class, newProject.getName(), newProject.getFromDate(), newProject.getToDate());
		return getProject(projectId1);
	}
