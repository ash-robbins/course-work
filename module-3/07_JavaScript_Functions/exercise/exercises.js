 ...
 */
 function makeNumber(first, second =''){
    let addingWord = first.concat(second);
    let result = parseInt(addingWord);
    return result;
}
/**
 ...
 */
function getFullAddressesOfProperties(streetNumber, streetName, streetType, city, state, zip){
